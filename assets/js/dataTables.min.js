...
[],i=0,m=a.aoColumns.length;i<m;i++)e.push(f[h][d[i]]);G(a,e)}else G(a,f[h]);a.aiDisplay=a.aiDisplayMaster.slice();a.bAjaxDataGet=!1;y(a);a.bAjaxDataGet=!0;H(a,!1)}function ya(a){var b=a.oPreviousSearch,c=a.oLanguage.sSearch,c=-1!==c.indexOf("_INPUT_")?c.replace("_INPUT_",'<input type="text" placeholder="الـبحـث"/>'):""===c?'<input type="text" placeholder="الـبحـث"/>':c+' <input type="text" placeholder="الـبحـث"/>',d=k.createElement("div");d.className=a.oClasses.sFilter;d.innerHTML="<label>"+c+"</label>";if(!a.aanFeatures.f)d.id=a.sTableId+"_filter";c=i("input",
...
data:j,success:function(e){i(k.oInstance).trigger("xhr",k);l(e)},dataType:"json",cache:!1,type:k.sServerMethod,error:function(e,i){"parsererror"==i&&alert("تحذير: لم يتمكن الخادم من معالجة البيانات المطلوبة, يحدث هذا بسبب خطأ في التنسيق")}})},fnServerParams:null,fnStateLoad:function(e){var e=this.oApi._fnReadCookie(e.sCookiePrefix+e.sInstance),j;try{j="function"===typeof i.parseJSON?i.parseJSON(e):eval("("+e+")")}catch(l){j=null}return j},fnStateLoadParams:null,fnStateLoaded:null,
fnStateSave:function(e,i){this.oApi._fnCreateCookie(e.sCookiePrefix+e.sInstance,this.oApi._fnJsonString(i),e.iCookieDuration,e.sCookiePrefix,e.fnCookieCallback)},fnStateSaveParams:null,iCookieDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iScrollLoadGap:100,iTabIndex:0,oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"الصفحة الاولي",sLast:"الصفحة الاخيرة",sNext:"التالي",sPrevious:"السابق"},sEmptyTable:"لا تتوافر بيانات في الجدول",
sInfo:"يعرض الان _START_ الي _END_ سجل من اصل _TOTAL_ سجل تم العثور عليهم",sInfoEmpty:"عرض 0 الي 0 من 0 صف",sInfoFiltered:"(من اصل _MAX_ سجل تم البحث فيهم)",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:" _MENU_ ",sLoadingRecords:"جاري التحميل...",sProcessing:"جاري المعالجة...",sSearch:"",sUrl:"",sZeroRecords:"لم يتم العثور على سجلات متطابقة"},oSearch:i.extend({},j.models.oSearch),sAjaxDataProp:"aaData",sAjaxSource:null,sCookiePrefix:"SpryMedia_DataTables_",sDom:"lfrtip",sPaginationType:"two_button",sScrollX:"",
