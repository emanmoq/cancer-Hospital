...
elFinder.prototype.view = function(fm, el) {
	...
	*/
	this.formatName = function(n) {
		...
		if (w>0) {
			if (n.length > w*2) {
				return n.substr(0, w)+"آ­"+n.substr(w, w-5)+"â€¦"+n.substr(n.length-3);
			} else if (n.length > w) {
				return n.substr(0, w)+"آ­"+n.substr(w);
			}
		}
		return n;
	}
	...
	help : function(fm) {
		...
		this.exec = function() {
			...
			a = '<div class="el-finder-help-std"/>'
				...
				+'<p>'+this.fm.i18n('Chezh localization')+': Roman Matؤ›na, info@romanmatena.cz</p>'
				...
				+'<p>'+this.fm.i18n('Latvian localization')+':  Uldis Plotiإ†إ،, uldis.plotins@gmail.com</p>'
				+'<p>'+this.fm.i18n('Poland localization')+':  Darek Wapiإ„ski, darek@wapinski.us</p>'
